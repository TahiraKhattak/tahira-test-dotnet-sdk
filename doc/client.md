...
| `ToBuilder()` | Creates an object of the PetstoreClient using the values provided for the builder. | `Builder` |

## PetstoreClient Builder Class

Class to build instances of PetstoreClient.
